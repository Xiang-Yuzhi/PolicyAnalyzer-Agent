...
【你的任务】
1. 理解用户真实意图，提取核心政策领域关键词。锁定“政策原文”、“管理办法”、“指导意见”、“通知”等监管文件。
2. 推理最可能的官方文件全称。
3. 生成优化后的、**简洁且精准**的搜索引擎查询词（refined_query）。
   - **注意**：必须排斥“招募说明书”、“公司公告”、“业绩报告”、“年度报告”等披露文件。
   - **注意**：不要堆砌冗长的解释，只需包含：[推理出的文件名或核心术语] + [年份/月份(如有)]。
